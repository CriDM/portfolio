        ...
        <div className="h-2/5 w-5/6 flex flex-row items-center  justify-around backdrop-blur-sm  shadow-minimal  shadow-black rounded-3xl">
          ...
          <div className="flex flex-col ml-6">
            <a
              ...
              target="_blank"
              className="text-white md:text-5xl  text-4xl font-bold relative font-tech  text-shadow-lg  "
            >
              Polecheck.de
            </a>
        ...
        <div className="h-2/5 w-5/6 flex flex-row items-center  justify-around backdrop-blur-sm  shadow-minimal  shadow-black rounded-3xl">
          <div className="flex flex-col ml-6">
            ...
            <p className="text-white  relative font-tech  text-shadow-lg shadow-dark-blue  mr-5">
              ...
              library extends the use of IPP to the browser.
              {!isMobile && (
                <>
                  With this library, you can easily integrate printing to
                  IPP-compatible network devices directly from your web
                  applications without having to rely on additional plugins or
                  software.
                </>
              )}
            </p>
